...
*********************************************************************
*/
CREATE DATABASE IF NOT EXISTS `jeeplatform` DEFAULT CHARACTER SET utf8;
...
CREATE TABLE `sys_permission` (
  ...
  PRIMARY KEY (`id`),
  KEY `p_fk_1` (`menuId`),
  CONSTRAINT `fk_permission_menuId` FOREIGN KEY (`menuId`) REFERENCES `sys_menu` (`menuId`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_permission_operation` (
  ...
  KEY `fk_permission_operation_operationId` (`operationId`),
  CONSTRAINT `fk_permission_operation_operationId` FOREIGN KEY (`operationId`) REFERENCES `sys_operation` (`id`),
  CONSTRAINT `fk_permission_operation_permissionId` FOREIGN KEY (`permissionId`) REFERENCES `sys_permission` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_role_permission` (
  ...
  CONSTRAINT `fk_role_permission_roleId` FOREIGN KEY (`roleId`) REFERENCES `sys_role` (`roleId`),
  CONSTRAINT `fk_role_permission_permissionId` FOREIGN KEY (`permissionId`) REFERENCES `sys_permission` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_user_role` (
  ...
  CONSTRAINT `fk_user_role_userId` FOREIGN KEY (`userId`) REFERENCES `sys_user` (`id`),
  CONSTRAINT `fk_user_role_roleId` FOREIGN KEY (`roleId`) REFERENCES `sys_role` (`roleId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `sys_user_role` */

insert  into `sys_user_role`(`userId`,`roleId`) values (1,1),(1,2),(2,2),(1,3),(2,3),(3,3),(1,4),(3,4),(1,6),(1,7),(3,7),(1,9),(4,9);
