...
public class BaseConfig {
     ...
     * repository 所在包
     */
    public static final String REPOSITORY_PACKAGES = "com.zsx.core.dao.repository.admin";

    /**
     * mapper 所在包
     */
    public static final String MAPPER_PACKAGES = "com.zsx.core.dao.mapper.admin";

    /**
     * 实体类 所在包
     */
    public static final String ENTITY_PACKAGES = "com.zsx.core.entity.admin";
